    ...
    >
      <section className="w-full flex justify-between mt-16 lg:flex-row flex-col relative">
        <div className="py-5 hidden lg:flex flex-col w-5/12 h-full justify-between z-10">
          ...
          <h1 className="inline bg-gradient-to-r from-yellow-500 via-blue-500 to-yellow-500 bg-clip-text font-display text-5xl font-normal tracking-tight text-transparent min-h-max">
            Nous sommes ravis de <span className="font-bold">vous revoir</span>
          </h1>
